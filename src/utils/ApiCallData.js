...
export const API_top_rated_movies = [
  {
    adult: false,
...
export const API_upcoming_movies = [
  {
    adult: false,
    backdrop_path: "/JtN7Q03S3oq7A4KZ7Z3I7m3osP.jpg",
    genre_ids: [28, 80, 53],
  ...
  },
  {
    ...
    popularity: 231.388,
    poster_path: "/vm1sLGAh14DoOSojgV5f1nDFSQh.jpg",
...
export const API_now_playing_movies = [
  {
    adult: false,
    backdrop_path: "/fqv8v6AycXKsivp1T5yKtLbGXce.jpg",
    genre_ids: [878, 12, 28],
...
export const API_trailer = {
  ...
  type: "Trailer",
  official: true,
  published_at: "2024-04-10T13:00:34.000Z",
  id: "66168f98fac50201480afb8f",
};
