...
import { PosterFull_URL } from "../utils/constant";
...
const MovieDetail = () => {
  ...
  return (
    close && movie_Details && <div className="fixed top-0 left-0 w-screen h-screen bg-black bg-opacity-80 z-40 ">
      ...
      <div className="fixed  top-1/2 left-1/2 -translate-y-[50%] -translate-x-[50%] w-[80%] sm:max-w-[60%] sm:max-h-[90%] overflow-hidden object-fill m-auto z-50 rounded-xl ">
