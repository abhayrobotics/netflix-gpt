...
const TitleContainer = ({title,overview}) => {
  return (
    <div className="py-72 sm:pt-96 w-svw aspect-video  pl-8 sm:pl-20 absolute bg-gradient-to-r z-0 from-black">
        <h2 className=" sm:__animateTitle text-2xl  font-bold   duration-1000  my-2 text-white">{title}</h2>   
        <p className="hidden sm:block w-2/5 text-white">{overview}</p>   
        <div className="my-2"> 
