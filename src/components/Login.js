  ...
  return (
    <div className="relative w-svw overflow-x-hidden ">
      ...
      <form
        ...
        className=" absolute top-1/2  -translate-y-[50%]  left-1/2   -translate-x-[50%]  p-16  w-[20rem] sm:w-3/12 min-w-[20rem] rounded-lg text-white z-10 bg-black  bg-opacity-80 "
      >
